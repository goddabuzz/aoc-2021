...
fun main() {
    ...
    result(part1(f(readInput("day09/Day09_test"))), 15)
    result(part2(f(readInput("day09/Day09_test"))), 1134)

    result(part1(f(readInput("day09/Day09"))), 423)
    result(part2(f(readInput("day09/Day09"))), 1198704)
}
