...
fun main() {
    ...
    result(part1(readInput("day11/Day11_test")), 1656)
    result(part1(readInput("day11/Day11")), 1591)
    result(part2(readInput("day11/Day11_test")), 195)
    result(part2(readInput("day11/Day11")), 314)
}
