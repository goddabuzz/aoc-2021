...
fun main() {
    result(part1(readInput(2021, 10, true)), 26397)
    result(part1(readInput(2021, 10)), 318081)

    resultLong(part2(readInput(2021, 10, true)), 288957)
    resultLong(part2(readInput(2021, 10)), 4361305341)
}
